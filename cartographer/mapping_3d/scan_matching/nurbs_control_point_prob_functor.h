...
#ifndef CARTOGRAPHER_MAPPING_3D_SCAN_MATCHING_NURBS_CONTROL_POINT_PROB_FUNCTOR_H_
#define CARTOGRAPHER_MAPPING_3D_SCAN_MATCHING_NURBS_CONTROL_POINT_PROB_FUNCTOR_H_
...
class NurbsControlPointProbFunctor {
 public:
  ...
  NurbsControlPointProbFunctor(const NurbsControlPointProbFunctor&) = delete;
  NurbsControlPointProbFunctor& operator=(const NurbsControlPointProbFunctor&) = delete;
  template<typename T>
...
#endif /* CARTOGRAPHER_MAPPING_3D_SCAN_MATCHING_NURBS_CONTROL_POINT_PROB_FUNCTOR_H_ */
