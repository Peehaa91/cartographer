...
// on.
struct Data {
  enum class Type { kImu, kRangefinder, kOdometer, kPlane };
  ...
  Data(const common::Time time, const Eigen::Vector4d& coefficients)
      : type(Type::kPlane), time(time), coefficients(coefficients){}
